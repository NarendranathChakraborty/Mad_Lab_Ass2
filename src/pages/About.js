...
const About = () => {
  return (
    <Layout>
      ...
      >
        <Typography variant="h4">Welcome to Sai Malhar Dhaba</Typography>
        <p>
          Welcome to GSai Malhar Dhaba, where culinary excellence meets passion
          ...
          At Sai Malhar Dhaba, our dedicated team of professionals is driven
        ...
        <p>
          ...
          Join us at Sai Malhar Dhaba on this exciting journey as we continue
          to innovate, grow, and make a difference in the world, one delightful
          dish at a time. Thank you for choosing Sai Malhar Dhaba for your
